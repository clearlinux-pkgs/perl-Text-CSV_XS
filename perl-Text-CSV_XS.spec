...
Source0  : https://cpan.metacpan.org/authors/id/H/HM/HMBRAND/Text-CSV_XS-1.53.tgz
...
%prep
%setup -q -n Text-CSV_XS-1.53
cd %{_builddir}/Text-CSV_XS-1.53
pushd ..
cp -a Text-CSV_XS-1.53 buildavx2
popd
