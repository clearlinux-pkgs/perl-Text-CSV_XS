...
Source0  : https://cpan.metacpan.org/authors/id/H/HM/HMBRAND/Text-CSV_XS-1.36.tgz
Summary  : Comma-Separated Values manipulation routines
Group    : Development/Tools
License  : Artistic-1.0-Perl
Requires: perl-Text-CSV_XS-lib
Requires: perl-Text-CSV_XS-man
...
%package man
Summary: man components for the perl-Text-CSV_XS package.
Group: Default

%description man
man components for the perl-Text-CSV_XS package.


%prep
%setup -q -n Text-CSV_XS-1.36
