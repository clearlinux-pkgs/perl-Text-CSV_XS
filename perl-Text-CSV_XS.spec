...
Source0  : https://cpan.metacpan.org/authors/id/H/HM/HMBRAND/Text-CSV_XS-1.57.tgz
...
%prep
%setup -q -n Text-CSV_XS-1.57
cd %{_builddir}/Text-CSV_XS-1.57
pushd ..
cp -a Text-CSV_XS-1.57 buildavx2
popd
